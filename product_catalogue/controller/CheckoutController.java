...
public class CheckoutController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Image Cheesecake = new Image(HomeController.blamp.getProductImage());
        ...
        Image CookiesNcream = new Image(HomeController.clamp.getProductImage());
        ...
        Image Matcha = new Image(HomeController.wlamp.getProductImage());
        img3.setImage(Matcha);

        name3.setText(HomeController.wlamp.getProductName());
        price3.setText(Double.toString(HomeController.wlamp.getProductPrice()));
        Image Strawberry = new Image(HomeController.wlamp.getProductImage());
    ...
    public void computeTotal(ActionEvent event) {
        ...
        if (HomeController.slamp.getProductStatus()) {
            ...
            HomeController.slamp.setProductQuantity(qty);
            item4Amount = HomeController.wlamp.getProductPrice() * qty;
