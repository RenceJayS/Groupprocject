...
public class ReceiptController implements Initializable {
    ...
    @FXML
    Label qty1, qty2, qty3, qty4, product1, product2, product3, product4, price1, price2, price3, price4, amount1, amount2, amount3, amount4, total;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (HomeController.slamp.getProductStatus()) {
            product4.setText(HomeController.slamp.getProductName());
            qty4.setText(Double.toString(HomeController.slamp.getProductQuantity()));
            ...
            item4Amount = HomeController.clamp.getProductPrice() * HomeController.clamp.getProductQuantity();
